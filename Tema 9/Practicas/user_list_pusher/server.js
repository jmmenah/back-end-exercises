...
const pusher = new Pusher({
  appId: "zzzzzzz",        // Replace with 'app_id' from dashboard
  key: "xxxxxxxxxxxxxxxxxxxx",         // Replace with 'key' from dashboard
  secret: "yyyyyyyyyyyyyyyyyyyy",   // Replace with 'secret' from dashboard
