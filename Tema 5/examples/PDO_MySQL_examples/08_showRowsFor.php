...
<html lang="en">
<head>
    <title>Data Table using for loop</title>
    <style>
        table, th, td {
...
?>
<h1>Data Table using for loop</h1>
<table>
    <tr>
    ...
    <?php
    // loop will be repeated as many times as rows the cursor has
    for ($count = 0; $count < $rowsNumber; $count++) {
        // data in $row variable
        $row = $doQuery->fetch(PDO::FETCH_ASSOC);
