...
if ($done || !isset($_GET['article_id'])) {
    $url = 'http://localhost/ch15-php-7-solutions/admin/blog_list_mysqli_03.php';
    if ($done) {
        $url .= '?updated=true';
    }
    header("Location: $url");
...
<p><a href="blog_list_mysqli_03.php">List all entries </a></p>
<?php if (isset($error)) {
...
<?php } else { ?>
<form method="post" action="blog_update_mysqli_03.php">
    <p>
