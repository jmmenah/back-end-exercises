            ...
            <table id="thumbs">
                <tr>
                    ...
                    <?php do {
                        ...
                        $firstRow = false;
                        ?>
                    <td><a href="gallery_mysqli_08.php?image=<?= safe($row['filename']) ?>&amp;curPage=<?= $curPage ?>">
                ...
                <tr><td>
                    ...
                    if ($curPage > 0) {
                        echo '<a href="gallery_mysqli_08.php?curPage=' . ($curPage-1) . '"> &lt; Prev</a>';
                    } else {
                    ...
                    if ($startRow+SHOWMAX < $totalPix) {
                        echo '<a href="gallery_mysqli_08.php?curPage=' . ($curPage+1) . '"> Next &gt;</a>';
                    } else {
                        // otherwise leave the cell empty
                        echo '&nbsp;';
                    }
