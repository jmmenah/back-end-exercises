...
if (!isset($_GET['article_id'])) {
    $url = 'http://localhost/ch15-php-7-solutions/admin/blog_list_pdo_03.php';
    header("Location: $url");
    exit;
}
if (isset($stmt)) {
...
<p><a href="blog_list_pdo_03.php">List all entries </a></p>
<?php if (isset($error)) {
...
<?php } else { ?>
<form method="post" action="blog_update_pdo_02.php">
    <p>
