                    ...
                    <form class="form-horizontal" id="add-student-form" method="post">
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" placeholder="Username" name="user_name" required id="username"
                                           class="span6">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" placeholder="First Name" name="last_name" required id="firstname"
                                           class="span6">
                                </div> <!-- /controls -->
                            </div> <!-- /control-group -->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="first_name" placeholder="Last Name" required id="lastname"
                                           class="span6">
                                </div> <!-- /controls -->
                            </div> <!-- /control-group -->
