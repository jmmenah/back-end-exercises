...
<div class="container">
    ...
    <h3 class="center">Chat Application using PHP Ajax Jquery</h3><br/>
    <br/>
    <div class="row">
        ...
        <div class="col-md-2 col-sm-3">
            <p class="right">Hi - <?php echo $_SESSION['username']; ?> - <a href="logout.php">Logout</a></p>
        </div>
    </div>
        ...
        <div class="chat_message_area">
            ...
            <div class="image_upload">
                <form id="uploadImage" method="post" action="upload.php">
                    <label for="uploadFile"><img src="upload.png" alt="upload"/></label>
...
<script>
    $(document).ready(function () {
        ...
        function make_chat_dialog_box(to_user_id, to_user_name) {
            ...
            modal_content += '</div><div class="form-group right">';
