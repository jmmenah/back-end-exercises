...
<div class="container">
    ...
    <div class="table-responsive">
        <h3 class="center">
            <a href="https://www.webslesson.info/2018/09/client-side-form-validation-using-parsleyjs-with-php-ajax.html">PHP
                Form Validation using Parsleys.js Library</a>
        </h3><br/>
        <div class="box">
            <form id="validate_form">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="confirm_password" id="confirm_password" placeholder="Confirm Password"
                           data-parsley-equalto="#password" data-parsley-trigger="keyup" required class="form-control"/>
                </div>
                <div class="form-group">
                    <label for="website">Website</label>
                    <input type="text" id="website" name="website" placeholder="Website URL" data-parsley-type="url"
                           data-parsley-trigger="keyup" class="form-control"/>
                </div>
                <div class="form-group">
                    <div class="checkbox">
                        <label><input type="checkbox" id="check_rules" name="check_rules" required/> I Accept the Terms
                            & Conditions</label>
                    </div>
                </div>
                <div class="form-group">
