...
if (isset($_POST["register"])) {
    ...
    if (is_array($user_data) && count($user_data) > 0) {
        ...
        if ($user_object->save_data()) {
            ...
            $mail->Username = 'xxxxxxxxxxxxxx';                     // Here enter your SMTP Username
            $mail->Password = 'yyyyyyyyyyyyyy';                    //Here enter your SMTP Password
            ...
            <p>Thank you for registering for Chat Application Demo.</p>
                ...
                <p><a href="http://localhost:8000/verify.php?code=' . $user_object->getUserVerificationCode() . '">Click to Verify</a></p>
                <p>Thank you...</p>
            ';
